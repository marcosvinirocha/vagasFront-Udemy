    ...
    salvarVaga() {
      ...
      if (this.validaFormulario()) {
        ...
        this.emitter.emit('alerta', {
          ...
          descricao: `Parabens a vaga foi cadastrada com sucesso na nossa plataforma`
        })
        this.limparFormulario()
      } else {
        this.emitter.emit('alerta', {
          tipo: 'erro',
          titulo: `Não  foi possivel realizar cadastro`,
          descricao: `Parece que voce esqueceu de preeencher alguma informação`
        })
      }
